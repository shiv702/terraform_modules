...
variable "cloudtrail_multi_region" { type = bool, default = true }
variable "cloudtrail_enable_cw_logs" { type = bool, default = true }

variable "sns_email_subscriptions" { type = map(string), default = {} }
